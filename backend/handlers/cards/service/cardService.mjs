...
// Service for Get deleted user cards
export const getDeletedUserCards = async (userId) => {
  const cards = await Card.find({ user_id: userId, isDeleted: true });
  return cards;
};

// Service for Restore card
